...
(function(){
  ...
  styfn.types = {
    ...
    curveStyle: { enums: [ 'bezier', 'unbundled-bezier', 'haystack', 'segments', 'straight', 'straight-triangle', 'taxi', 'complex-taxi', 'simple', 'coords' ] },
  ...
  let edgeLine = [
    ...
    { name: 'coords-points', type: t.bidirectionalSizes, triggersBounds: diff.any },
    ...
    { name: 'complex-taxi-vertical-padding', type: t.size, triggersBounds: diff.any },
    { name: 'complex-taxi-horizontal-padding', type: t.size, triggersBounds: diff.any },
